...
ROM struct{BYTE report[HID_RPT01_SIZE];}hid_rpt01={
{
    ...
    0x09, 0x01,             // 	Usage (defined by vendor)
    0xA1, 0x01,             // 	Collection (defined by vendor)

    0x19, 0x01,             //  Usage Minimum (defined by vendor) 
	0x29, 0x05,             //  Usage Maximum (defined by vendor)
    0x15, 0x00,             //  Logical Minimum (mininum value = 0)
    0x25, 0xFF,  	  	    //  Logical Maximum (maximum value = 0xFF)
